            ...
            <div className='w-full py-12 px-6 lg:py-16 lg:pr-16 z-20'>
              ...
              <div className='lg:mt-0 lg:flex-shrink-0'>
                <div className='mt-0 sm:mt-6 inline-flex rounded-md shadow w-full sm:w-36'>
                  <button
                    type='button'
                    className='py-2 px-4 bg-gray-500 hover:bg-gray-700 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md hover:scale-110 rounded-lg '
                  >
                    Book Ride
                  </button>
                </div>
